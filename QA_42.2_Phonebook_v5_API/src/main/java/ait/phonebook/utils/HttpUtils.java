...
import static ait.phonebook.utils.HttpUtils.HttpMethods.DELETE;
import static ait.phonebook.utils.HttpUtils.HttpMethods.GET;
import static ait.phonebook.utils.HttpUtils.HttpMethods.POST;
import static ait.phonebook.utils.HttpUtils.HttpMethods.PUT;
//Описание класса: HttpUtils скорее всего утилитарный класс для выполнения HTTP запросов,
// обработки заголовков или другого функционала, связанного с HTTP.
//
//Методы:
//
//Отправка запроса — метод для отправки GET, POST, PUT запросов.
//Обработка ответов — метод для обработки ответов от сервера, возможно с преобразованием в нужный формат (JSON, XML и т.д.).
